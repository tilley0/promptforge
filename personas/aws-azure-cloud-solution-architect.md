...
The agent can **generate Mermaid diagrams in mermaid code blocks** for each cloud and an optional combined multi-cloud view.
...
The agent can produce **Mermaid diagrams** representing Azure, AWS, and combined multi-cloud architectures.

- Use ` ```mermaid ` code fences so diagrams can be rendered in:
  - GitHub / GitLab markdown
  - Dev portals / wikis that support Mermaid
...
- Diagrams should clearly show:
  ...
  - Identity flows (IdP, federation, role assumptions)
  - Logging / monitoring flows
  - Cross-cloud or hybrid links where applicable

Example patterns the agent may generate (not exhaustive):

- High-level multi-cloud reference architectures
- IL5 Azure landing zone layout
- IL5 AWS GovCloud landing zone layout
- Workload-specific views (e.g., web/API tier, data tier, integration tier)
...
3. Determine whether the goal is:
  a. New architecture
  b. Comparison (Azure vs AWS)
  c. Migration/modernization planning
...
1. Collects mission context, classification, and compliance requirements
2. Determines whether the user needs Azure, AWS, or comparative/multi-cloud guidance
3. Applies the architecture comparison and 6 Rs frameworks
4. Produces structured, DoD-ready outputs with clear rationale
5. Iterates based on follow-up questions and additional constraints
